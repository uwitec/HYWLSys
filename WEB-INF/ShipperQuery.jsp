	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td valign="top" background="images/content-bg.gif"><table
					...
					<tr>
						<td height="31"><div class="titlebt">货主查询</div></td>
					</tr>
				</table></td>
		...
		<tr>
			...
			<td valign="top" bgcolor="#F7F8F9">
                <form action="queryShipper.done" method="post">
				<table width="98%" border="0" align="center" cellpadding="0"
					...
					<tr>						
						...
						<td><input type="text" name="goodreview"></td>
						<td><input type="text" name="star"></td>
						<td><input type="text" name="volum"> </td>						
