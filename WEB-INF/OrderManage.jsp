			...
			<td valign="top" bgcolor="#F7F8F9">
				...
				<table width="98%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td >手机号：<input type="text" name="phone" width="20px"></td>
						<td >用户名：<input type="text" name="username" width="20px"></td>
						<td >积分：<input type="text" name="integral" width="20px"></td>
						<td >好评率：<input type="text" name="goodreview" width="20px"></td>
						<td >星级：<input type="text" name="star" width="20px"></td>
						<td >交易总：<input type="text" name="volum" width="20px"> </td>
